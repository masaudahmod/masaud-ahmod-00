import {
  facebook, linkedin, instagram, twitter, github, facebook1, linkedin1, instagram1, twitter1, github1, tvshowbox, guesstheword, tictactoe, mathmagician, metricwebapp, spacetravelers, recipeapp, trackbudget, carrental, responsive, react, fullstack, 
} from '../assets';
...
const social = [
  ...
  },
  {
    id: 2,
    name: 'Facebook',
    url: 'https://www.facebook.com/masaudahmod',
    icon: facebook,
    icon1: facebook1,
  },
  {
    id: 3,
    name: 'Instagram',
    url: 'https://www.instagram.com/masaudahmod',
    icon: instagram,
    icon1: instagram1,
  },
  {
  ...
  },
  {
    id: 5,
    name: 'Github',
    url: 'https://github.com/masaudahmod',
    icon: github,
    icon1: github1,
  },
];
