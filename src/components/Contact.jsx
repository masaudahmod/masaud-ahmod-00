...
import contactLottie from "../assets/contact-lottie.json"; // lottie Animation
    ...
    <>
      ...
      <div className={style.container}>
        <motion.form
          ...
          action="https://formspree.io/f/xnnqvpyy"
          method="post"
        ...
        >
          <Lottie animationData={contactLottie} loop={false} />
        </motion.div>
      </div>
    </>
  );
